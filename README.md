...
* Optimization file for initial model by [Karatza and Karalis, (2020)](https://onlinelibrary.wiley.com/doi/10.1111/bcpt.13321) validation (Optimizations/optimization for initial model)
...
### Optimization settings for initial model validation:
...
### Optimization settings for E-max model validation:
1. Optimization method: SRES (stochastic ranking evolutionary strategy)
2. Number of iterations: 500
3. Survival size: 20
4. Initial simulation time: 0
5. Completion simulation time: 10000
6. Simulation time increment: 1
7. Selected engine: ODE Simulation Engine
8. Simulator name: JVODE

How to reproduce the data you can see [here](https://github.com/DBgentech2023sirius/CYP2C9/blob/master/INSTRUCTIONS.md).
___
